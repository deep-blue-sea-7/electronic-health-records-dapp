...
describe("Records", () => {
  ...
  it("can create appointment using doctor account", async () => {
    ...
    await record.methods
      .setDoctor("001107020345", "Josn", "0123456789", "Male", "07/22/2024", "Doctorate", "Virology")
      .send({ from: accounts[1], gas: "5000000" });

    await record.methods
      .setAppointment(accounts[0], "07/07/2024", "11:50pm", "Amoxicillin", "Requires observation", "Skin Infection", "Pending")
      .send({ from: accounts[1], gas: "5000000" });
