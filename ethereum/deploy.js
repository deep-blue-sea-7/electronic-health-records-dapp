...
//Link to the sepolia network by using Infura and providing seed phrase of metamask wallet
const provider = new HDWalletProvider("MM Mnemonic", "INFURA URL/KEY");
...
const deploy = async () => {
  ...
  //Deploy contract to the sepolia network
