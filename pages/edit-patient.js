  ...
  onSubmit = async (event) => {
    ...
    try {
      ...
      await record.methods
        .editDetails(ic, name, phone, gender, dob, height, weight, houseaddr, bloodgroup, allergies, medication, emergencyName, emergencyContact)
    ...
    return (
      <Layout>
        <Segment padded raised color="teal">
          <h2 style={{ color: "#088395" }}>Edit Record</h2>
        </Segment>
          ...
          <Form onSubmit={this.onSubmit} error={!!this.state.errorMessage}>
            ...
            <Form.Group widths="equal">
              <Form.TextArea
                rows="1"
                label="House Address"
                placeholder="1234, Jalan Seksyen 1/3, 31900 Kampar, Perak"
