...
class RegisterDoctor extends Component {
  ...
  onSubmit = async (event) => {
    ...
    try {
      ...
      await record.methods.setDoctor(ic, name, phone, gender, dob, qualification, major).send({ from: accounts[0] });

      toast.success("Doctor account was created successfully!");
    } catch (err) {
    ...
    return (
      <Layout>
        <Segment padded raised color="teal">
          <h2 style={{ color: "#088395" }}>Register New Doctor</h2>
        </Segment>
