...
class EditAppointment extends Component {
  ...
  onSubmit = async (event) => {
    ...
    try {
      ...
      await record.methods.updateAppointment(patientaddr, date, time, diagnosis, prescription, description, status).send({ from: accounts[0] });
    ...
    return (
      <Layout>
        <Segment padded raised color="teal">
          <h2 style={{ color: "#088395" }}>Update an Appointment</h2>
        </Segment>
