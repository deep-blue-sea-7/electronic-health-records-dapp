        ...
        <>
          <Card.Group centered itemsPerRow="2">
            <Card color={this.props.patGrowthColor}>
              <Card.Content>
                <Image floated="right" size="mini" src="https://cdn-icons-png.flaticon.com/512/858/858736.png" />
          ...
          <Card.Group centered itemsPerRow="4">
            <Card>
              <Card.Content>
                <Image floated="right" size="mini" src="https://cdn-icons-png.flaticon.com/128/1512/1512910.png" />
            ...
            <Card>
              <Card.Content>
                <Image floated="right" size="mini" src="https://cdn-icons-png.flaticon.com/128/3481/3481061.png" />
            ...
            <Card>
              <Card.Content>
                <Image floated="right" size="mini" src="https://cdn-icons-png.flaticon.com/128/2693/2693507.png" />
            ...
            <Card>
              <Card.Content>
                <Image floated="right" size="mini" src="https://cdn-icons-png.flaticon.com/128/1642/1642097.png" />
              ...
              >
                <defs>
                  <linearGradient id="colorPatients" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#78D6C6" stopOpacity={0.8} />
                    <stop offset="95%" stopColor="#78D6C6" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="colorDoctors" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#1450A3" stopOpacity={0.8} />
                    <stop offset="95%" stopColor="#1450A3" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <XAxis dataKey="Name" />
                <YAxis />
                ...
                <Tooltip />
                <Legend />
                <Area type="monotone" dataKey="Doctors" stroke="#1450A3" fillOpacity={1} fill="url(#colorDoctors)" />
                <Area type="monotone" dataKey="Patients" stroke="#78D6C6" fillOpacity={1} fill="url(#colorPatients)" />
              </AreaChart>
            </ResponsiveContainer>
          </Segment>
          ...
          <Segment padded>
            ...
            <ResponsiveContainer width="100%" aspect={3}>
              ...
              >
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="Count" stroke="#78D6C6" activeDot={{ r: 8 }} />
              </LineChart>
            </ResponsiveContainer>
          </Segment>
